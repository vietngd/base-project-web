      ...
      <section className="mb-12">
        ...
        <Grid cols={3} gap="lg">
          ...
          <Card padding="lg" shadow="lg" hover>
            ...
            <p className="text-gray-600">Card with large shadow, hover effect, and large padding.</p>
          </Card>
        ...
        <Card padding="lg">
          ...
          <div>
            ...
            <Flex gap="md" wrap="wrap">
              ...
              <Badge variant="warning" rounded>Rounded Warning</Badge>
            </Flex>
          </div>
        </Card>
      </section>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            This is a modal component from the design system. It includes a backdrop, 
